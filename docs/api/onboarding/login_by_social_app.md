# Login Social APP
Application: SignIn-Facebook, AppleSignin, googlePopupSignin
...
| :--------------- | :-------- | :-------- | :----- | :-------------------------------------------------------------------------------------------- |
| Id               | Int       | YES       |        |                                                                                               |
| Company          | Int       | YES       |        | Refer to [Bank](../../reference/reference_codes.md#credit-card-company)                          |
